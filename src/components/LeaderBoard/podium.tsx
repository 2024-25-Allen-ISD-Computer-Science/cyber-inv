...
export default function TeamPodium({ teams = [] }: PodiumProps) {
  ...
  return (
    <div className="flex items-end justify-center w-full h-full gap-2 text-card-foreground p-4">
      {/* Second place */}
      <div className="flex flex-col items-center w-1/3">
        ...
        <div className="w-full h-24 bg-accent rounded-md"></div>
      </div>
      ...
      <div className="flex flex-col items-center w-1/3">
        ...
        <div className="w-full h-32 bg-accent rounded-md"></div>
      </div>
